  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 flex items-center justify-center shadow-lg cursor-pointer"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-6 z-40 w-[min(380px,calc(100vw-48px))] h-[min(520px,calc(100vh-120px))] bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 flex flex-col overflow-hidden"
          >
            {/* Header */}
                              ...
                              >
                                {results.slice(0, 5).map((r, j) => (
                                  <a
                                    ...
                                    className="block text-xs bg-white/60 dark:bg-zinc-700/60 rounded-lg px-2.5 py-1.5 hover:bg-white dark:hover:bg-zinc-700 transition-colors"
                                  >
